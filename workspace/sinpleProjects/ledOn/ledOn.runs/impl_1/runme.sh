...
HD_PWD='/home/ayuba/Zybo_Image_Processing/Zybo_Image_Processing/workspace/sinpleProjects/ledOn/ledOn.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple1_wrapper.tcl -notrace
