...
HD_PWD='/home/ayuba/Zybo_Image_Processing/Zybo_Image_Processing/workspace/sinpleProjects/ledOn/ledOn.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple1_wrapper.tcl
