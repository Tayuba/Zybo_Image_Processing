...
HD_PWD='/home/ayuba/Zybo_Image_Processing/Zybo_Image_Processing/workspace/simpleProjects/LedPushButton/LedPushButton.runs/PushButton_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PushButton_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PushButton_axi_gpio_0_0.tcl
