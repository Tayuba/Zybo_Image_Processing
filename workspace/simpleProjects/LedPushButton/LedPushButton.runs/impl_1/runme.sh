...
HD_PWD='/home/ayuba/Zybo_Image_Processing/Zybo_Image_Processing/workspace/simpleProjects/LedPushButton/LedPushButton.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PushButton_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PushButton_wrapper.tcl -notrace
