...
HD_PWD='/home/ayuba/Zybo_Image_Processing/Zybo_Image_Processing/workspace/simpleProjects/LedPushButton/LedPushButton.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PushButton_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PushButton_wrapper.tcl
