...
HD_PWD='/home/ayuba/Zybo_Image_Processing/Zybo_Image_Processing/workspace/sinpleProjects/ledOn/ledOn.runs/simple1_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple1_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple1_auto_pc_0.tcl
